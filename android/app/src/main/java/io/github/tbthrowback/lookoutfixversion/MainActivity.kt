...
class MainActivity : AppCompatActivity() {
    ...
    @Volatile private var pendingLaunch: LaunchFile? = null
    ...
    private val fileChooserLauncher =
            registerForActivityResult(ActivityResultContracts.StartActivityForResult()) { result ->
                ...
                val uris =
                        if (result.resultCode == Activity.RESULT_OK && data != null) arrayOf(data)
                        else null
    ...
    private val createDocumentLauncher =
            registerForActivityResult(ActivityResultContracts.CreateDocument("*/*")) { outputUri ->
                ...
                try {
                    ...
                    Toast.makeText(this, "Unable to save ${request.fileName}", Toast.LENGTH_LONG)
                            .show()
                }
            }
    ...
    private fun inputResponse(): WebResourceResponse? {
        ...
        val inputStream =
                contentResolver.openInputStream(launchFile.uri)
                    ...
                    Intent.ACTION_SEND_MULTIPLE -> {
                        ...
                        ?: clipData?.let { clip ->
                            if (clip.itemCount > 0) clip.getItemAt(0).uri else null
                                ...
                                ?: return null
        val name =
                uri.displayName() ?: uri.lastPathSegment?.substringAfterLast('/') ?: "winmail.dat"
    ...
    private fun guessMimeType(
        ...
        return guessed
                ?: when (assetName.substringAfterLast('.', "").lowercase()) {
                    "html" -> "text/html"
                    "css" -> "text/css"
    ...
    private inner class AndroidBridge {
        ...
        fun downloadFile(fileName: String?, mimeType: String?, base64Data: String?) {
            ...
            val safeName = sanitizeFileName(fileName?.ifBlank { null } ?: "attachment.bin")
        ...
        @JavascriptInterface
        fun openFile(fileName: String?, mimeType: String?, base64Data: String?) {
            if (base64Data.isNullOrBlank()) {
                return
            }
